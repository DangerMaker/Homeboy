package com.adg.homeboy.player;
...
public class MoviePlayActivity extends AppCompatActivity implements View.OnClickListener, PlaybackPreparer,
    ...
    public void onVisibilityChange(int visibility) {
        Log.e("onVisibilityChange", visibility + "");
    }
...
//            }
    ...
    private DataSource.Factory buildDataSourceFactory(boolean useBandwidthMeter) {
        return ((App) getApplication()).buildDataSourceFactory(useBandwidthMeter ? BANDWIDTH_METER : null);
    }
